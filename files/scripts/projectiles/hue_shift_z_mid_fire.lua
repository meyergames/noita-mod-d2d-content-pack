...
function try_pick_up_spell( card )
	...
	-- TODO: might be harder to do: this function puts spells at the start
...
if is_mid_fire_pressed() and GameGetFrameNum() >= cooldown_frame then
    ...
    if inventory_items ~= nil then
        local card_14 = get_card_at_inv_slot( 14 )
        local card_15 = get_card_at_inv_slot( 15 )
        local card_16 = get_card_at_inv_slot( 16 )

        try_drop_and_cache_spell( 15, card_14 )
        try_drop_and_cache_spell( 16, card_15 )
        try_drop_and_cache_spell( 14, card_16 )
