...
local break_force_mid = 2147
local break_force_end = 2147
local break_distance_end = 2147
local break_distance_mid = 2147
...
if dist > segment_length then
	...
	-- TOP* segment. attach to root with id 445
	...
	{
		type = "REVOLUTE_JOINT",
		offset_x = x + 1.5, -- center the joint (because the sprite is 3px wide?)
		offset_y = y - segment_length, -- joint is on the TOP* of the shape
		body1_id = 445,
		body2_id = body_id,
	...
	EntityAddComponent2( entity_id, "PhysicsJoint2Component",
	{
		...
		break_distance = break_distance_end,
		ray_x = 0,
		ray_y = -32, -- not sure what this does
	})
end
