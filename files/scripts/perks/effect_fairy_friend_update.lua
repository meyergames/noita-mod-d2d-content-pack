...
local animals = EntityGetInRadiusWithTag( x, y, 300, "helpless_animal" )
if ( #animals > 0 ) then
    for i,animal_id in ipairs( animals ) do
        if string.find( EntityGetName( animal_id ), "fairy_" ) then
            EntityAddTag( animal_id, "fairy" )
        end
    end
end
