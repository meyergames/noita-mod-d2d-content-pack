...
function shot( entity_id )
	...
	local etypes = { "ray_energy", "sparks_count_max", "camera_shake", "damage", "material_sparks_count_max", "physics_explosion_power.max" }
	...
	-- ComponentObjectSetValue2( projectile, "config_explosion", "ray_energy", current_raynrg_value * 1.0 + ( 0.5 * master_of_explosions_pickup_count ) )
