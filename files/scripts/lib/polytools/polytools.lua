...
local base64 = dofile_once("mods/D2DContentPack/files/scripts/lib/polytools/base64.lua")
...
function polytools.polymorph(target, poly_into, duration, keep_ui, components_file, end_on_death)
    ...
    if proj and proj.on_death_explode then
        ...
        target:addComponent("LuaComponent",
                            {script_source_file = "mods/D2DContentPack/files/scripts/lib/polytools/fix_projectiles.lua",
                             execute_every_n_frame = 0, remove_after_executed = true})
    end
    local effect = target:addGameEffect("mods/D2DContentPack/files/scripts/lib/polytools/effect.xml")
    ...
    effect:addComponent("LuaComponent",
                        {script_source_file = "mods/D2DContentPack/files/scripts/lib/polytools/apply.lua", execute_on_added = true,
...
function polytools.hide(target, duration)
    ...
    local effect = target:addGameEffect("mods/D2DContentPack/files/scripts/lib/polytools/effect_silent.xml")
    effect.GameEffectComponent.polymorph_target = "mods/D2DContentPack/files/scripts/lib/polytools/null.xml"
...
function polytools.spawn(x, y, data, delay_load)
    ...
    if delay_load then
        ...
        entity:addComponent("LuaComponent", {script_source_file = "mods/D2DContentPack/files/scripts/lib/polytools/delay_load.lua",
