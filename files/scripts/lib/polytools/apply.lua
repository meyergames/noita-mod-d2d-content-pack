...
if worm_ai then
    ...
    if keep_ui then
        ...
        parent:loadComponents("mods/D2DContentPack/files/scripts/lib/polytools/ui/player_base_worm.xml", true)
    end
    ...
    if keep_ui then
        ...
        parent:loadComponents("mods/D2DContentPack/files/scripts/lib/polytools/ui/player_base.xml", true)
...
if not parent.PlatformShooterPlayerComponent then
    parent:loadComponents("mods/D2DContentPack/files/scripts/lib/polytools/ui/player_base_hide.xml", true)
end
...
if parent.DamageModelComponent then
    ...
    self:addComponent("LuaComponent",
                      {script_source_file = "mods/D2DContentPack/files/scripts/lib/polytools/ui/on_remove.lua",
...
if self.var_bool.end_on_death then
    ...
    parent:addComponent("LuaComponent", {execute_every_n_frame = -1,
                                         script_damage_received = "mods/D2DContentPack/files/scripts/lib/polytools/depoly_death.lua"})
end
