...
{
    {
		...
		ui_icon="mods/D2DContentPack/files/gfx/ui_gfx/status_effects/viral_infection_012.png",
		protects_from_fire=false,
		effect_entity="mods/D2DContentPack/files/entities/misc/status_effects/effect_virus.xml",
