ctq_status_effects = 
{
...

    {
		...
		ui_icon="mods/RiskRewardBundle/files/gfx/ui_gfx/status_indicators/borrowed_time_012.png",
		protects_from_fire=false,
		effect_entity="mods/RiskRewardBundle/files/entities/misc/effect_virus_weak.xml",
        effect_permanent=true,
    },
}
