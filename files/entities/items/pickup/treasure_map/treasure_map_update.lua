...
local function ping( id )
	...
	if distance > range * 0.5 then
		GameCreateSpriteForXFrames( "mods/D2DContentPack/files/entities/items/pickup/treasure_map/indicator_treasure_faint.png", indicator_x, indicator_y )
	elseif distance > range * 0.25 then
		GameCreateSpriteForXFrames( "mods/D2DContentPack/files/entities/items/pickup/treasure_map/indicator_treasure_medium.png", indicator_x, indicator_y )
	elseif distance > 10 then
		GameCreateSpriteForXFrames( "mods/D2DContentPack/files/entities/items/pickup/treasure_map/indicator_treasure_strong.png", indicator_x, indicator_y )
	end
end

-- ping nearby items and wands
for _,id in pairs( EntityGetInRadiusWithTag( pos_x, pos_y, range, "chest" ) ) do
